...
git branch -M main
git remote add origin git@github.com:snorben/eeg_preprocessing_umcu
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/snorben/repositories/new](https://github.com/organizations/snorben/repositories/new)
and create a new repository named `eeg_preprocessing_umcu` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/snorben/eeg_preprocessing_umcu/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
